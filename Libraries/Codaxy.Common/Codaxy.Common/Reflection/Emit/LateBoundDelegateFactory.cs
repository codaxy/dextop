...
namespace Codaxy.Common.Reflection
{
    ...
    public static class LateBoundDelegateFactory
    {
        public static Func<T, object> CreateGet<T>(MemberInfo memberInfo)
        {
            ...
            throw new Exception("Could not create getter for {0}.".FormatWith(memberInfo));
        }
        ...
        public static Action<T, object> CreateSet<T>(MemberInfo memberInfo)
        {
            ...
            throw new Exception("Could not create setter for {0}.".FormatWith(memberInfo));
        }

        public static MethodDelegate CreateMethodHandler(MethodBase method)
        {
        ...
        public static Func<object> CreateDefaultConstructor(Type type)
        {
            ...
            else
            {
                ...
                if (constructorInfo == null)
                    throw new Exception("Could not get constructor for {0}.".FormatWith(type));
        ...
        public static Func<T, object> CreateGet<T>(PropertyInfo propertyInfo)
        {
            ...
            if (getMethod == null)
                throw new Exception("Property '{0}' does not have a getter.".FormatWith(propertyInfo.Name));
