Ext.define('Ext.ux.grid.plugin.ActionManager', {
    ...
    hideDisabledActionsInContextMenu: false,
    ...
    showContextMenu: function (e, deselect) {
        ...
        if (!this.contextMenu || this.hideDisabledActionsInContextMenu) {
        ...
        for (var i = 0; i < this.actions.length; i++) {
            if (this.actions[i] === '->')
                ...
                if (!this.actions[i].skipInContextMenu) {
                    if (!this.hideDisabledActionsInContextMenu || !this.actions[i].isDisabled || !this.actions[i].isDisabled())
